...
# ПЕРВАЯ СТРОКА ОТВЕТА АГЕНТА (правило в скилле task-update): прибор кладёт
# готовую строку ПЕРВОЙ строкой additionalContext, и модель берёт её слово
# в слово (T200 ⑤). systemMessage остаётся в выводе, но на него как на канал
# владельца не рассчитывать.
#
