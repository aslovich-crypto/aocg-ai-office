...
# ⚠️ СКОЛЬКО ЖИВЁТ ССЫЛКА НА СНИМОК. Семь суток — предел подписи S3 (SigV4),
# больше выдать нельзя технически. Значит файл, пролежавший дольше недели,
# ссылки на снимки теряет, и выгрузку надо повторить. Сказано вслух, потому
# что молчаливо протухшая ссылка выглядит как «снимка не было».
ЖИЗНЬ_ССЫЛКИ_НА_СНИМОК = 7 * 24 * 60 * 60
