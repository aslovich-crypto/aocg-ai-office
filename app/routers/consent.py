...
# Версия 1.0 = ПЕРВАЯ И ЕДИНСТВЕННАЯ редакция. Журнал согласий очищен
# 07.08.2026 (19 строк периода разработки: user_id='local_user', адрес пуст,
# текст-черновик), поэтому истории версий не существует и нумерация начинается
# с начала. «1.1 как исправленная редакция» имела смысл, пока старые записи
# лежали в базе; записей нет — нет и повода.
